...
def main():
    ...
    avaliacoes_final_tensor, modelos_clientes, modelos_clientes_perdas = treinar_modelos_locais_lis(modelo_global_federado1, avaliacoes_inicial_tensor, criterion, 200)
