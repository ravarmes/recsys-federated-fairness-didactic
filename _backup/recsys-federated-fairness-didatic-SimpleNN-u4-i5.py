...
def treinar_modelos_locais(modelo_global, avaliacoes_inicial, criterion, epochs=50, learning_rate=0.01):
    ...
    NR_ADVANTAGED_GROUP = 2     # número de avaliações geradas para os clientes do grupo dos favorecidos
    NR_DISADVANTAGED_GROUP = 0  # número de avaliações geradas para os clientes do grupo dos desfavorecidos
...
def main():
    ...
    avaliacoes_final_tensor, modelos_clientes, modelos_clientes_rindv, modelos_clientes_loss, modelos_clientes_nr = treinar_modelos_locais(modelo_global_federado1, avaliacoes_inicial_tensor, criterion, 200)
